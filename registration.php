...
if (isset($_POST['regbtn'])) {
    ...
    $confPass = md5($_POST['userconfpass']);
    $status = "active";
    if ($password === $confPass) {
        $sql = "INSERT INTO $TBL_USER(user_reg_datetime, user_username, user_email, user_password, user_status) VALUES ('$entry_datetime','$username','$email','$password','$status')";
